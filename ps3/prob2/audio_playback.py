...
# Generated: Sun Mar  6 17:39:39 2016
##################################################
...
class audio_playback(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.fractional_resampler_xx_0 = filter.fractional_resampler_ff(0, playback_rate)
        ...
        self.connect((self.fractional_resampler_xx_0, 0), (self.blocks_throttle_0, 0))    
    ...
    def set_playback_rate(self, playback_rate):
        ...
        self.fractional_resampler_xx_0.set_resamp_ratio(self.playback_rate)
