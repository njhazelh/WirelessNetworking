...
class pskrx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Pskrx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Pskrx")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "pskrx")
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps, 6.28/100, (filter.firdes.root_raised_cosine(32, 32 * sps, 1.0, 0.35, 11 * 32 * sps)), 32, 16, 1.5, 1)
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(sps, 0.35, 55, 6.28/100.0)
        self.digital_diff_decoder_bb_0 = digital.diff_decoder_bb(constel.arity())
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(constel, 6.28/100, -0.25, 0.25)
        ...
        self.analog_agc2_xx_0 = analog.agc2_cc(.06, .001, 1.0, 1.0)
...
def main(top_block_cls=pskrx, options=None):
